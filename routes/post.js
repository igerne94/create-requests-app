...
router.get('/', getPosts); //only one rout, gives POST
//! only if this validation: .. passed, it goes next to  createPost
router.post('/post', validator.createPostValidator, createPost); // from frontend we are going to post to the backend
